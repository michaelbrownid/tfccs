...
class Model():
    def __init__(self, args):
        ...
        baseadj = KK.layers.Conv2D(128, kernel_size= (2, 2), activation='relu', padding="same")(inputs)
        # layer: name conv2d outputshape [None, 16, 640, 128]

        baseadjperm = KK.backend.permute_dimensions(baseadj,(0,2,1,3))
        baseadjpermreshape = KK.layers.Reshape((640, 16*128))(baseadjperm)
        predBase0 = KK.layers.TimeDistributed( KK.layers.Dense(64, activation='softmax'))(baseadjpermreshape)
