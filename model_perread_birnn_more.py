...
class Model():
    ...
    def __init__(self, args):
        ...
        readNumberTileSq = KK.layers.Lambda( lambda xx: KK.backend.squeeze(xx,axis=-1))(readNumberTile)
        readNumberTileEmbed = KK.layers.Embedding(input_dim=1, output_dim=8, name="readNumberTileEmbed")(readNumberTileSq) # [None, 640, 8]
        ...
        colcoverageSq = KK.layers.Lambda( lambda xx: KK.backend.squeeze(xx,axis=-1))(colcoverage)
        colcoverageEmbed = KK.layers.Embedding(input_dim=1, output_dim=8, name="colcoverageEmbed")(colcoverageSq) # [None, 640, 8]

        #### concat all together [None, 640, 4+8+8+8+1] = [None, 640, 29]
